...
#include <iomanip>
    ...
    /*std::endl : places a new line character on the output stream.
      ...
      stdd::right/left/internal : Justify : Values can be justified in their fields. There are three manipulators
      std::setfill : Sets the filler char
      ...
      std::uppercase/nouppercase(default)
      ...
      std::showpoint/noshowpoint(default) : show trailing zeros if necessary*/
